...
class StarsBackground extends Component {
  componentDidMount() {
    ...
    let starForge = function () {
      ...
      materialOptions = {
        size: 2, //I know this is the default, it's for you.  Play with it if you want.
        //transparency: true,
        opacity: 0.7,
        map: sprite,
      ...
      new THREE.Color(13, 202, 240)
      new THREE.Color(255, 59, 91)
      new THREE.Color(22, 36, 71)
      new THREE.Color(31, 64, 104)
      */
    ...
    let init = function () {
      ...
      if (window.DeviceOrientationEvent) {
        window.addEventListener(
          "deviceorientation",
          function (eventData) {
            var tiltX = Math.round(eventData.gamma * 20);
            var tiltY = Math.round(eventData.beta * 20);
